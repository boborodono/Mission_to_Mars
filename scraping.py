...
def hemi_data(browser):
    ...
    for i in range(4):
        ...
        #? Create a dictionary to hold hemisphere image & title
        hemisphere_images = {}
        hemisphere_images['img_url'] = f'http://marshemispheres.com/{img_url}'
        hemisphere_images['title'] = title
